...
#endif /* STM32F10X_XL */		   //如果定义STM32F10X_XL说明使用大容量低密度器件，该器件提供MPU所以定义__MPU_PRESENT为1否则为0
#define __NVIC_PRIO_BITS          4 /*!< STM32 uses 4 Bits for the Priority Levels    */   //说明STM32使用多少位确定中断优先级
#define __Vendor_SysTickConfig    0 /*!< Set to 1 if different SysTick Config is used */    //说明是否使用系统滴答定时器
